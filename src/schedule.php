...
<!--<div style="border-color: #ddd; border-style: none solid none solid; border-width: 1.5rem; margin: 2rem 2rem 0rem 2rem; font-size: 0.4rem;">&nbsp;</div>-->
<!--<span style="background-color: #ddd; border: 0.4rem solid #ddd; border-radius: 0.5rem; font-size:0.1rem; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>-->
<div style="margin: 0rem 4rem; font-size: 0.1rem; background-color: #eee;">&nbsp;</div>
<div style="align: center; margin-top: 0em; margin-bottom: 0rem; padding: 0.3rem 0.7rem; border: 0.4rem solid #ddd; border-radius: 2rem;">
<!--
...
<div style="border-color: #eee; border-style: none solid none solid; border-width: 1.5rem; margin: 0rem 2rem; font-size: 0.2rem;">&nbsp;</div>
</div>
...
The workshop's timezone is <a href="https:/time.is/EDT">Eastern Daylight Time</a> (UTC-4).
<br>
...
<!--Export calender 
to <a href="https://calendar.google.com/calendar/render?cid=https%3A%2F%2Fmath-data.github.io%2Fbig-data-pure-math-2022%2FBigDataPureMath22.ics">Google Calendar</a> 
and <a href="BigDataPureMath22.ics">iCal/Outlook/others</a>.-->
<a href="BigDataPureMath22.ics">Export calender (*.ics)</a>
